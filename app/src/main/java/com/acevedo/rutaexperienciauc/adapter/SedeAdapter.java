...
public class SedeAdapter extends RecyclerView.Adapter<SedeAdapter.SedeHolder> implements View.OnClickListener {
    ...
    public SedeAdapter(Context context, List<Sede> sedeList) {
    ...
    public SedeHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View mView = LayoutInflater.from(context).inflate(R.layout.sede_item, parent, false);
